...
import "./about.css";
import AboutImg from "../../assets/self.jpg";
import Resume from "../../assets/Shreeraj_Pawar_Resume.pdf";
import Info from './Info';

const About = () => {
  return (
    <section className="about section" id="about">
      <span className="section_label reveal">About</span>
      <h2 className="section_title reveal">Building systems that scale cleanly</h2>
      <span className="section_subtitle reveal">Software engineer focused on backends, cloud, and product delivery</span>

      <div className="about_container container grid reveal">
        <img src={AboutImg} alt="Shreeraj Pawar" className="about_img" />

        <div className="about_data">
          <Info />

          <p className="about_description">
            I&apos;m Shreeraj Pawar, a Software Engineer currently at Humatics in Boston,
            with an MS in Computer Science from New York University. I work across
            real-time dashboards, AWS data pipelines, REST APIs, and AI-assisted tooling —
            with a focus on performance, reliability, and maintainable code.
          </p>

          <a href={Resume} className="buttons button--flex" target="_blank" rel="noreferrer">
            Download resume
            <svg
